Feature: add
  ...
  Scenario Outline: Add valid sweet
    ...
    Then The user fill in id of sweet with "<id_of_sweet>" and The User fill in name of sweet with "<name_of_sweet>" and The User fill in type of sweet with "<type_of_sweet>"
  ...
  Scenario Outline: Add sweet with id already exist
    Given The user login as Owner or Supplier with "<email>" and "<password>"
    When The user add an existing id of sweet with the id "<id_of_sweet>" and the name "<name_of_sweet>" and the type "<type_of_sweet>"
    ...
    Examples:
      | email                | password     | id_of_sweet | name_of_sweet    | type_of_sweet |
      | supg856SS@gmail.com  |kfh6j3nur58   | 01          | Cake of chocolate | zero sugar    |
      | supg856SS@gmail.com  |kfh6j3nur58   | 01          | Salt cake         | diet          |
